...
public class ModelViewerInput implements IEditorInput {
	...
	private static HashMap<Integer, ClassDiagramGraphicalModel> mModelList =
			new HashMap<Integer, ClassDiagramGraphicalModel>();
     ...
     * @throws RuntimeException if the dispose() method has already been called.
     */
